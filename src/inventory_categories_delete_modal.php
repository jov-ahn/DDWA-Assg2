    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalLabel">Delete Inventory Category</h5>
            ...
            <form action="inventory_categories_db.php" method="POST" class="needs-validation" novalidate>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="delete-inventory-category" class="btn btn-primary">Confirm</button>
                </div>
            </form>
        </div>
    </div>
