    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Edit Inventory Category</h5>
            ...
            <form action="inventory_categories_db.php" method="POST" class="needs-validation" novalidate>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="edit-inventory-category" class="btn btn-primary">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
